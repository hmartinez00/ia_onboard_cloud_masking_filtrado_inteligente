...
Nuestras contribuciones incluyen un pipeline completo de procesamiento on-board (ver Figura~\ref{fig:pipeline}), una evaluación exhaustiva en hardware emulado y comparaciones sistemáticas contra enfoques del estado del arte. Misiones demostradoras como Φ-sat-2 ya han validado el concepto de filtrado inteligente en órbita, estableciendo un precedente sólido para implementaciones más ambiciosas \cite{PhiSat2_Overview}. 
